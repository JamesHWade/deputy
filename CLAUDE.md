...
Its `original`, `changed-constraint` and `resolved-methods` scenarios cover retained
and superseded host eligibility rules plus resolved pending work with the same
