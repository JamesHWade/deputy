...
uses `reticulate` + Python `markitdown`.
...
can request explicit human approval.
[`permissions_plan()`](https://jameshwade.github.io/deputy/reference/permissions_plan.md)
allows read-only annotated tools and `ask_user`.
...
- [`vignette("permissions")`](https://jameshwade.github.io/deputy/articles/permissions.md) -
  Permission modes and custom policies
