...
`working_dir` always remain authoritative. Saved run context is
validated before conversation state changes, then merged with
constructor context; protected identity conflicts fail the load.
