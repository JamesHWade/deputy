---
title: "Agent SDK Compatibility"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Agent SDK Compatibility}
...
Agent SDK-compatible facade on top. This vignette shows what is covered by the
...
|--------|--------|----------------|
| `agent_sdk_query()` / `claude_sdk_query()` / `query()` | Covered | `agent_sdk_query()`, `claude_sdk_query()`, and `AgentSDKClient$query()` |
...
the package Anthropic-specific. Plugins and marketplace execution remain
deferred until the settings and agent surface is more mature.
