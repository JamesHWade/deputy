...
The lead and the reviewers all run in read-only mode, so nobody changes a
file. Read-only mode still lets the lead delegate, because its subagents can't
use a less strict mode than the lead.
