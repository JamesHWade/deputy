...
Check `is_success()` before passing a result to the next step. Use `validate`
for application rules; invalid output or an unavailable validator signals an
error, and bounded corrections are opt-in:
