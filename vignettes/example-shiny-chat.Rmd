...
docs <- docs_init("example-shiny-chat", "illustrative")
```

```{r, echo = FALSE, results = 'asis'}
docs$status_block("`run_shiny()` itself is covered in the automated test suite.")
```

Illustrative example only: this page is not executed during pkgdown builds.
