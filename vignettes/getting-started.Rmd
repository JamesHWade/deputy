...
deputy is an agentic AI framework for R that builds on [ellmer](https://ellmer.tidyverse.org/). It enables you to create AI agents that can use tools to accomplish multi-step tasks, with built-in support for permissions, hooks, and streaming output.
...
For real-time feedback, use the `run()` method which returns a generator:
