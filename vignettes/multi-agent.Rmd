...
ellmer tools and caller-supplied Skill objects. Their closures, services, and
mutable reference state remain caller-owned; a frozen definition does not make
those objects immutable. `S7::props()` retains these objects, so use the YAML
