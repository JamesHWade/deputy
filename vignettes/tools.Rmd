...
access, and any allowlist, denylist, or custom callback is evaluated without
request arguments. Other provider-native tool types are rejected. Use the
universal tools when authorization must inspect each request. If
