...
docs <- docs_init("tools", "verified-vcr")
...
```{r tools-custom-demo, eval = docs$should_eval}
...
```{r tools-web-demo, eval = docs$should_eval}
search_results <- docs$use_vcr("web-tools", {
  tool_web_search("R language site", num_results = 1)
})
