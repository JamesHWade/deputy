...
A load failure warns, records a failed attempt in `mcp_status()`, and leaves
the registry unchanged; malformed metadata never silently becomes an
unannotated executable.
